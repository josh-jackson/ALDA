...
| 3    | 9/12   |  Conditional (Level 1 and 2 predictors) MLM models  | purrr  |  Hw#2                |
| 4    | 9/19   |  Polynomial, piecewise and spline models   |  plotting redux     |  Hw#3      |
| 5    | 9/26   |  Three level and group models       |   brms   | Hw#4                     |
| 6    | 10/03  | Intensive data analysis/within person fluctuations p1 | brms  |                     |
| 7    | 10/10  | Intensive data analysis/within person fluctuations p2 | tidybayes  | Hw#5         |
| 8    | 10/17   |   SEM and simple path models                    |  lavaan       |         |
| 9    | 10/24  | Latent Grown (curve) Models   |  amelia            |     Hw#6                 |
| 10   | 10/31  |   MI and Second order Model |   semPlot                 |                      |
| 11   | 11/7  |    Multiple group models |   lavaan          |    Hw#7                  |
| 12   | 11/14   |  *Class canceled*     |                   |                      |
| 13   | 11/21  |  Flexible SEM models (LCM, STATE-TRAIT; ALT-SR) |          |    Hw#8                  |
